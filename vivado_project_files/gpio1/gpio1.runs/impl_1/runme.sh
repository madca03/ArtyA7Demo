...
HD_PWD='D:/Drive/1/UP Files/CoE111/Vivado/demo/gpio1/gpio1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gpio.tcl -notrace
