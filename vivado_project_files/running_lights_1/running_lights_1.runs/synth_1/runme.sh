...
HD_PWD='D:/Drive/1/UP Files/CoE111/Vivado/demo/running_lights_1/running_lights_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log running_lights.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source running_lights.tcl
