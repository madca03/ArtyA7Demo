...
HD_PWD='D:/Drive/1/UP Files/CoE111/Vivado/demo/running_lights_1/running_lights_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log running_lights.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source running_lights.tcl -notrace
