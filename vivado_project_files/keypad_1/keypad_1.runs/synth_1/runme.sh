...
HD_PWD='D:/Drive/1/UP Files/CoE111/Vivado/demo/vivado_project_files/keypad_1/keypad_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log keypad.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source keypad.tcl
