...
HD_PWD='D:/Drive/1/UP Files/CoE111/Vivado/demo/vivado_project_files/keypad_1/keypad_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log keypad.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source keypad.tcl -notrace
